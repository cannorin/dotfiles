...
#コマンドモード
function vim-nor-color(){
case ${UID} in
    0)
        PROMPT="%B%{[0m%}%/%{[32m%} [NOR] %{[0m%}#%{[0m%}%b "
        PROMPT2="%B%{[0m%}%_%{[32m%} [NOR] %{[0m%}#%{[0m%}%b "
        SPROMPT="%B%{[0m%}%r is correct? [n,y,a,e] %{[32m%} [NOR] %{[0m%}:%{[0m%}%b "
        ;;
    *)
        PROMPT="%/ %{[32m%}[NOR] %{[0m%}$%{[0m%} "
        PROMPT2="%_%{[32m%} [NOR] %{[0m%}$%{[0m%} "
        RPROMPT="%{[36m%}[${USER}@${HOST}]%{[0m%}"
        SPROMPT="%{[0m%}%r ? [nyae] %{[32m%}[NOR] %{[0m%}:%{[m%} "
        ;;
esac
}

#挿入モード
function vim-ins-color(){
case ${UID} in
    0)
        PROMPT="%B%{[0m%}%/%{[34m%} [INS] %{[0m%}#%{[0m%}%b "
        PROMPT2="%{[0m%}%_%{[34m%} [INS] %{[0m%}$%{[0m%} "
        SPROMPT="%B%{[0m%}%r is correct? [n,y,a,e] %{[34m%} [INS] %{[0m%}:%{[0m%}%b "
        ;;
    *)
        PROMPT="%/ %{[34m%}[INS] %{[0m%}$%{[0m%} "
        PROMPT2="%_%{[34m%} [INS] %{[0m%}#%{[0m%}%b "
        RPROMPT="%{[36m%}[${USER}@${HOST}]%{[0m%}"
        SPROMPT="%{[0m%}%r ? [nyae] %{[34m%}[INS] %{[0m%}:%{[0m%} "
        ;;
esac
}
